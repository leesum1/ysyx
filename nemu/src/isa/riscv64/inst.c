...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  /*add by leesum*/
  INSTPAT("??????? ????? ????? ??? ????? 01101 11", auipc, U, R(dest) = src1);
  ...
  INSTPAT("??????? ????? ????? 011 ????? 00100 11", sltiu, I, R(dest) = U64(src1) < BITS(U64(src2), 5, 0));
  ...
  INSTPAT("??????? ????? ????? 000 ????? 00100 11", addi, I, R(dest) = src1 + src2);
  INSTPAT("000000? ????? ????? 001 ????? 00100 11", slli, I, R(dest) = U64(src1) << BITS(src2, 5, 0));
  INSTPAT("000000? ????? ????? 001 ????? 00110 11", slliw, I, R(dest) = SEXT(U64(src1) << BITS(src2, 5, 0), 32));
  INSTPAT("000000? ????? ????? 101 ????? 00110 11", srliw, I, R(dest) = SEXT(U32(src1) >> BITS(src2, 5, 0), 32));
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli, I, R(dest) = U64(src1) >> BITS(src2, 5, 0));
  INSTPAT("0000000 ????? ????? 101 ????? 01100 11", srl, I, R(dest) = U64(src1) >> BITS(src2, 5, 0));
  INSTPAT("0100000 ????? ????? 101 ????? 01110 11", sraw, R, R(dest) = S32(src1) >> BITS(src2, 5, 0));
  INSTPAT("0000000 ????? ????? 101 ????? 01110 11", srlw, R, R(dest) = SEXT(U32(src1) >> BITS(src2, 4, 0), 32));
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai, I, R(dest) = S64(src1) >> BITS(src2, 5, 0));
  INSTPAT("010000? ????? ????? 101 ????? 00110 11", sraiw, I, R(dest) = SEXT(S32(src1) >> BITS(src2, 5, 0), 32));
  ...
  INSTPAT("0000000 ????? ????? 011 ????? 01100 11", sltiu, R, R(dest) = (U64(src1) < U64(src2)) ? 1 : 0);
