...
IFDEF(CONFIG_DIFFTEST,extern void difftest_skip_ref();)
...
static inline int check_csr_idx(int idx) {
  ...
  case 0x344: IFDEF(CONFIG_DIFFTEST,difftest_skip_ref());return mip;break; // mip
  ...
  default:  Log("csr error, addr 0x%x", idx);return 0;; break;
  }
}
