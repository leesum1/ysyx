...
static bool is_mtime_trap = false;
static int skip_dut_nr_inst = 0;

bool get_is_skip_ref() { return is_skip_ref; }

void difftest_rise_mtime_trap(void) { is_mtime_trap = true; }
...
void difftest_step(vaddr_t pc, vaddr_t npc) {
  ...
  if (is_mtime_trap) {
    ref_difftest_raise_intr(cpu.csr[mcause]);
    is_mtime_trap = false;
  }
