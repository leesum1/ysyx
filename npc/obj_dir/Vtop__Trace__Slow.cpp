...
void Vtop___024root__traceInitSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+104,"top rst", false,-1);
        ...
        tracep->declBit(c+103,"top u_pc clk", false,-1);
        tracep->declBit(c+104,"top u_pc rst", false,-1);
        ...
        tracep->declBus(c+105,"top u_pc u_regpc WIDTH", false,-1, 31,0);
        tracep->declQuad(c+106,"top u_pc u_regpc RESET_VAL", false,-1, 63,0);
        tracep->declBit(c+103,"top u_pc u_regpc clk", false,-1);
        tracep->declBit(c+104,"top u_pc u_regpc rst", false,-1);
        tracep->declQuad(c+24,"top u_pc u_regpc din", false,-1, 63,0);
        tracep->declQuad(c+1,"top u_pc u_regpc dout", false,-1, 63,0);
        tracep->declBit(c+108,"top u_pc u_regpc wen", false,-1);
        tracep->declQuad(c+1,"top u_fetch inst_addr", false,-1, 63,0);
        tracep->declBus(c+3,"top u_fetch inst_data", false,-1, 31,0);
        tracep->declQuad(c+26,"top u_fetch mem_data", false,-1, 63,0);
        ...
        tracep->declBit(c+103,"top u_rv64reg clk", false,-1);
        ...
        tracep->declBit(c+108,"top u_rv64reg wen", false,-1);
        {int i; for (i=0; i<32; i++) {
                tracep->declQuad(c+28+i*2,"top u_rv64reg rf", true,(i+0), 63,0);}}
        ...
        tracep->declQuad(c+92,"top u_execute u_alu alu_a_i", false,-1, 63,0);
        tracep->declQuad(c+94,"top u_execute u_alu alu_b_i", false,-1, 63,0);
        ...
        tracep->declBus(c+105,"top u_execute u_alu u_Vectorinvert1 DATA_LEN", false,-1, 31,0);
        tracep->declQuad(c+92,"top u_execute u_alu u_Vectorinvert1 in", false,-1, 63,0);
        tracep->declQuad(c+97,"top u_execute u_alu u_Vectorinvert1 out", false,-1, 63,0);
        tracep->declBus(c+109,"top u_execute u_alu u_Vectorinvert1 i", false,-1, 31,0);
        tracep->declBus(c+105,"top u_execute u_alu u_Vectorinvert2 DATA_LEN", false,-1, 31,0);
        tracep->declQuad(c+99,"top u_execute u_alu u_Vectorinvert2 in", false,-1, 63,0);
        tracep->declQuad(c+101,"top u_execute u_alu u_Vectorinvert2 out", false,-1, 63,0);
        tracep->declBus(c+109,"top u_execute u_alu u_Vectorinvert2 i", false,-1, 31,0);
...
void Vtop___024root__traceFullSub0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+3,((IData)(vlSelf->top__DOT__u_fetch__DOT__mem_data)),32);
        ...
        tracep->fullBit(oldp+23,(((IData)(vlSelf->top__DOT__u_memory__DOT___unsigned) 
                                  | (IData)(vlSelf->top__DOT__u_memory__DOT___signed))));
        tracep->fullQData(oldp+24,((((3U == (IData)(vlSelf->top__DOT__u_dcode__DOT___pc_op))
                                    ...
                                    + ((4U == (IData)(vlSelf->top__DOT__u_dcode__DOT___pc_op))
                                        ? 4ULL : ((
                                                   ...
                                                   : 0ULL)))),64);
        tracep->fullQData(oldp+26,(vlSelf->top__DOT__u_fetch__DOT__mem_data),64);
        tracep->fullQData(oldp+28,(vlSelf->top__DOT__u_rv64reg__DOT__rf[0]),64);
        tracep->fullQData(oldp+30,(vlSelf->top__DOT__u_rv64reg__DOT__rf[1]),64);
        tracep->fullQData(oldp+32,(vlSelf->top__DOT__u_rv64reg__DOT__rf[2]),64);
        tracep->fullQData(oldp+34,(vlSelf->top__DOT__u_rv64reg__DOT__rf[3]),64);
        tracep->fullQData(oldp+36,(vlSelf->top__DOT__u_rv64reg__DOT__rf[4]),64);
        tracep->fullQData(oldp+38,(vlSelf->top__DOT__u_rv64reg__DOT__rf[5]),64);
        tracep->fullQData(oldp+40,(vlSelf->top__DOT__u_rv64reg__DOT__rf[6]),64);
        tracep->fullQData(oldp+42,(vlSelf->top__DOT__u_rv64reg__DOT__rf[7]),64);
        tracep->fullQData(oldp+44,(vlSelf->top__DOT__u_rv64reg__DOT__rf[8]),64);
        tracep->fullQData(oldp+46,(vlSelf->top__DOT__u_rv64reg__DOT__rf[9]),64);
        tracep->fullQData(oldp+48,(vlSelf->top__DOT__u_rv64reg__DOT__rf[10]),64);
        tracep->fullQData(oldp+50,(vlSelf->top__DOT__u_rv64reg__DOT__rf[11]),64);
        tracep->fullQData(oldp+52,(vlSelf->top__DOT__u_rv64reg__DOT__rf[12]),64);
        tracep->fullQData(oldp+54,(vlSelf->top__DOT__u_rv64reg__DOT__rf[13]),64);
        tracep->fullQData(oldp+56,(vlSelf->top__DOT__u_rv64reg__DOT__rf[14]),64);
        tracep->fullQData(oldp+58,(vlSelf->top__DOT__u_rv64reg__DOT__rf[15]),64);
        tracep->fullQData(oldp+60,(vlSelf->top__DOT__u_rv64reg__DOT__rf[16]),64);
        tracep->fullQData(oldp+62,(vlSelf->top__DOT__u_rv64reg__DOT__rf[17]),64);
        tracep->fullQData(oldp+64,(vlSelf->top__DOT__u_rv64reg__DOT__rf[18]),64);
        tracep->fullQData(oldp+66,(vlSelf->top__DOT__u_rv64reg__DOT__rf[19]),64);
        tracep->fullQData(oldp+68,(vlSelf->top__DOT__u_rv64reg__DOT__rf[20]),64);
        tracep->fullQData(oldp+70,(vlSelf->top__DOT__u_rv64reg__DOT__rf[21]),64);
        tracep->fullQData(oldp+72,(vlSelf->top__DOT__u_rv64reg__DOT__rf[22]),64);
        tracep->fullQData(oldp+74,(vlSelf->top__DOT__u_rv64reg__DOT__rf[23]),64);
        tracep->fullQData(oldp+76,(vlSelf->top__DOT__u_rv64reg__DOT__rf[24]),64);
        tracep->fullQData(oldp+78,(vlSelf->top__DOT__u_rv64reg__DOT__rf[25]),64);
        tracep->fullQData(oldp+80,(vlSelf->top__DOT__u_rv64reg__DOT__rf[26]),64);
        tracep->fullQData(oldp+82,(vlSelf->top__DOT__u_rv64reg__DOT__rf[27]),64);
        tracep->fullQData(oldp+84,(vlSelf->top__DOT__u_rv64reg__DOT__rf[28]),64);
        tracep->fullQData(oldp+86,(vlSelf->top__DOT__u_rv64reg__DOT__rf[29]),64);
        tracep->fullQData(oldp+88,(vlSelf->top__DOT__u_rv64reg__DOT__rf[30]),64);
        tracep->fullQData(oldp+90,(vlSelf->top__DOT__u_rv64reg__DOT__rf[31]),64);
        tracep->fullQData(oldp+92,(vlSelf->top__DOT__u_execute__DOT___alu_in1),64);
        tracep->fullQData(oldp+94,(vlSelf->top__DOT__u_execute__DOT___alu_in2),64);
        tracep->fullBit(oldp+96,(((((((((9U == (IData)(vlSelf->top__DOT__u_dcode__DOT___alu_op)) 
                                  ...
                                  | ((0x12U == (IData)(vlSelf->top__DOT__u_dcode__DOT___alu_op)) 
                                     & (~ (IData)(vlSelf->top__DOT__u_execute__DOT__u_alu__DOT___isCF))))));
        tracep->fullQData(oldp+97,(vlSelf->top__DOT__u_execute__DOT__u_alu__DOT___shifter_in1_inv),64);
        tracep->fullQData(oldp+99,(vlSelf->top__DOT__u_execute__DOT__u_alu__DOT___shifter_res),64);
        tracep->fullQData(oldp+101,(vlSelf->top__DOT__u_execute__DOT__u_alu__DOT___srl_res),64);
        tracep->fullBit(oldp+103,(vlSelf->clk));
        tracep->fullBit(oldp+104,(vlSelf->rst));
        tracep->fullIData(oldp+105,(0x40U),32);
        tracep->fullQData(oldp+106,(0x80000000ULL),64);
        tracep->fullBit(oldp+108,(1U));
