...
`define ALUOP_SLTI `ALUOP_LEN'd14
`define ALUOP_SLTIU `ALUOP_LEN'd15

`define ALUOP_BEQ `ALUOP_LEN'd16
`define ALUOP_BNE `ALUOP_LEN'd17
`define ALUOP_BLT `ALUOP_LEN'd18
`define ALUOP_BGE `ALUOP_LEN'd19
`define ALUOP_BLTU `ALUOP_LEN'd20
`define ALUOP_BGEU `ALUOP_LEN'd21
